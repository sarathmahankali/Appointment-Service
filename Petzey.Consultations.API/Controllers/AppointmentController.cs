...
namespace Petzey.Consultations.API.Controllers
{
    ...
    public class AppointmentController : ApiController
    {
        ...
        /// <returns></returns>
        [HttpPatch]
        [Route("changestatus/{VetId}")]
        public IHttpActionResult ChangeStatus([FromBody] AppointmentStatusDTO appointmentStatusDTO, int VetId)
        {
            var result = service.ChangeAppointmentStatus(appointmentStatusDTO, VetId);
