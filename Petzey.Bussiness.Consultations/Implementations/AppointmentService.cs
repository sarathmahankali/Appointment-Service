...
namespace Petzey.Bussiness.Consultations.Implementations
{
    public class AppointmentService:IAppointmentService
    {
        ...
        public VitalDTO AddVital(VitalDTO vital)
        {
            ...
            Vital p = service.ConvertToVital(vital);
        ...
        {
            Vital vitals = service.ConvertToVital(vital);
        ...
        {
            Vital v = vitalRepository.GetVitalById(VitalId);
            return service.ConvertToVitalDTO(v);
        }

        public VitalDTO GetVitalByAppointmentId(int AppointmentId)
        {
            Vital v = vitalRepository.GetVitalByAppointmentId(AppointmentId);
            return service.ConvertToVitalDTO(v);
        }

        public TestDTO AddTest(TestDTO test)
        { 
            Test t  = service.ConvertToTest(test);
            Test Test1=  testRepository.AddTestyAppId(t);
        ...
        {
            Test t = service.ConvertToTest(test);
            Test Test1 = testRepository.UpdateTest(t);
            return service.ConvertTotestDTO(Test1); 
        }
        ...
        {
            Symptom symptom1 = service.ConvertToSymptom(symptom);
